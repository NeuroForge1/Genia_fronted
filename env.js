...
const ENV = {
  ...
  // OpenAI
  OPENAI_API_KEY: '', // Se debe configurar en el archivo .env
  
  // Twilio
  TWILIO_SID: '', // Se debe configurar en el archivo .env
  TWILIO_AUTH_TOKEN: '', // Se debe configurar en el archivo .env
  ...
  STRIPE_SECRET_KEY: '', // Se debe configurar en el archivo .env
